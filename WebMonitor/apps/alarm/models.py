...
class InfectAlarm(models.Model):
    ...
    risk_id = models.ForeignKey(InfectRisk, on_delete=models.PROTECT,verbose_name='感染风险预警编号')
    staff_id = models.ForeignKey(User, on_delete=models.PROTECT,verbose_name='机场管理人员编号')
