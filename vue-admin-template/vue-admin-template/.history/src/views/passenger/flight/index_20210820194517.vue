...
export default {
  data() {
    return {
      ...
      searchtime:['2021-08-02T16:00:00.000Z','2021-08-03T16:00:00.000Z'],
      // 所有的数据变量定义在此处
      value: "",
      input: "",
      // 表格数据
  ...
  watch: {
    params: {
      handler: function (newparams, oldparams) {
        ...
        this.params.start_time: this.formatDateTime(this.searchtime[0]);
        this.params.end_time: this.formatDateTime(this.searchtime[1]);
        // console.log(this.formatDateTime(this.searchtime[0]),'starttime');
        // console.log(this.formatDateTime(this.searchtime[1]),'endtime');
        // 重新加载数据
        this.fetchFlightData();
      },
  ...
  methods: {
    ...
    fetchFlightData: function () {
      ...
      request({
        ...
        params: this.params,
        //[0]),"end_time":this.formatDateTime(this.searchtime[1])},
