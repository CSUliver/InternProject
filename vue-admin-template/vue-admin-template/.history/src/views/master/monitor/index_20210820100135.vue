  ...
  <div id="body">
    ...
    <div id="new">
      ...
      <div id="datatable">
        ...
        >
        <el-table-column label="监测点编号" width="100">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.id }}</span>
            </template>
          </el-table-column>
          <el-table-column label="监测点位置" width="100">
            <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    addUserInfo:function(){
      ...
      addform.append('username',this.addform.username)
      addform.append('password',this.addform.password)
      request({
        url:"/users/users/",
        method:"post",
    ...
    editInfo:function(){
      ...
      editform.append('username',this.editform.username)
      editform.append('password',this.editform.password)
      console.log(this.editform.id,"hhhhhhhhhhhhhhhhhhhhhhhh")

      request({
        url:"users/users/" + this.editform.id,
        method:"patch",
        headers:{"Content-Type":"multipart/form-data"},
        data:editform
      }).then(res=>{
