<template>
  <div id="body">
    <!-- 页面左侧，为机场航班信息 -->
    <div id="new" style="width: 400px; height: 450px; margin-top:10px">
      <el-button
        type="primary"
        plain
        style="float: right"
      ...
      <!-- 2.数据展示表格 -->
      <div id="datatable" style="width: 400px; height: 450px; margin-top:10px">
        <el-table
          border
          :data="tableData"
          style="width: 100%"
        >
        <el-table-column label="监测点编号" width="300px">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.id }}</span>
            </template>
          </el-table-column>
          <el-table-column label="监测点位置" width="300px">
            <template slot-scope="scope">
              <el-tag  type="success" effect="light">{{ scope.row.position }}</el-tag>
