<template>
  <div id="body">
    <!-- 页面左侧，为机场航班信息 -->
    <div id="new" style="width: 50px; height: 600px; margin-top:10px">
      <el-button
        type="primary"
        plain
      ...
      <div id="datatable">
        ...
        >
        <el-table-column label="监测点编号" width="200">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.id }}</span>
            </template>
          </el-table-column>
          <el-table-column label="监测点位置" width="200">
            <template slot-scope="scope">
      ...
      <div id="pagenations">
        <el-pagination
          style="float: right; height: 600px; margin-top: 1000px"
          background
