  ...
  <div id="body">
    ...
    <div id="left" style="width: 1000px; height: 600px; margin-top:10px">
      ...
      <el-select
        ...
        <el-option label="旅客" value="Y"></el-option>
        <el-option label="机组人员" value="NY"></el-option>
        <el-option label="旅客" value="N"></el-option>
      </el-select>
        <el-date-picker
      ...
      <div id="datatable">
        ...
        <el-table-column label="监测事件id" width="100">
          ...
          <el-table-column label="监测事件" width="100">
            <template slot-scope="scope">
          ...
          <!-- <el-table-column label="受监测人员感染状态">
            <template slot-scope="scope">
          ...
          <el-table-column label="感染状态">
            <template slot-scope="scope">
              <span v-if ="scope.row.person_infect==='Y'" style="margin-left: 10px">{{ "确诊" }}</span>
              <span v-else-if="scope.row.person_infect==='NY'" style="margin-left: 10px">{{ "无症状感染" }}</span>
              <span v-else-if="scope.row.person_infect==='N'" style="margin-left: 10px">{{ "正常" }}</span>
