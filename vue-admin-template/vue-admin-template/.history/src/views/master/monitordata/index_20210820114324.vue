  ...
  <div id="body">
    ...
    <div id="left" style="width: 1000px; height: 600px; margin-top:10px">
      ...
      <el-select
        ...
        <el-option label="未感染" value="Y"></el-option>
        <el-option label="无症状感染" value="NY"></el-option>
        <el-option label="感染" value="N"></el-option>
      </el-select>
        <el-date-picker
          v-model="params.time"
          type="datetimerange"
      ...
      <div id="datatable">
        ...
        <el-table-column label="监测事件id" width="100">
          ...
          <el-table-column label="监测时间" width="100">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.time }}</span>
            </template>
          </el-table-column>
          <el-table-column label="受监测人员类型">
          <template slot-scope="scope">
          ...
          <el-table-column label="感染状态">
            <template slot-scope="scope">
              <span v-if ="scope.row.person_infect==='Y'" style="margin-left: 10px">{{ "感染" }}</span>
              <span v-else-if="scope.row.person_infect==='NY'" style="margin-left: 10px">{{ "无症状感染" }}</span>
              <span v-else-if="scope.row.person_infect==='N'" style="margin-left: 10px">{{ "未感染" }}</span>
    ...
    <el-dialog title="新增监测点" :visible.sync="addFormVisible">
      ...
      <el-form :model="addform">
        <el-form-item label="监测事件id" :label-width="formLabelWidth">
          <el-input
            v-model="addform.id"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="监测点时间" :label-width="formLabelWidth">
          <el-input
            v-model="addform.time"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="受监测人员类型" :label-width="formLabelWidth">
          <el-input
            v-model="addform.person_type"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="受监测人员id" :label-width="formLabelWidth">
          <el-input
            v-model="addform.person_id"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="受监测人员姓名" :label-width="formLabelWidth">
          <el-input
            v-model="addform.person_name"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="受检测人员体温" :label-width="formLabelWidth">
          <el-input
            v-model="addform.person_temperature"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="感染状态" :label-width="formLabelWidth">
          <el-input
            v-model="addform.person_infect"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="执勤人员编号" :label-width="formLabelWidth">
          <el-input
