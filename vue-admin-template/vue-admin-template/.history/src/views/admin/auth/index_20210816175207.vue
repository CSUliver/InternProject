    ...
    <div id="datatable">
      <el-table border :data="tableData" style="width: 100%; margin-top: 15px">
        ...
        <el-table-column label="管理员权限">
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.is_superuser ? '机场管理员' : '其他用户'"
              placement="top"
            >
              <el-switch
        ...
        <el-table-column label="用户类别">
          <template slot-scope="scope">
            ...
            <el-tag v-if="scope.row.person_type==='passenger'">旅客</el-tag>
            <el-tag v-if="scope.row.person_type==='flight'" type="info">机组人员</el-tag>
            <el-tag v-if="scope.row.person_type==='airport'" type="warning">机场工作人员</el-tag>
          </template>
        </el-table-column>
