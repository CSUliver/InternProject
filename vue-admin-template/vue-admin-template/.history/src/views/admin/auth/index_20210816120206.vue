    ...
    <div id="datatable">
      <el-table border :data="tableData" style="width: 100%; margin-top: 15px">
        ...
        <el-table-column label="是否为管理员">
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.is_superuser ? '超级管理员' : '普通用户'"
              placement="top"
            >
              <el-switch
        ...
        <el-table-column label="用户类别">
          <template slot-scope="scope">
            <span>{{ scope.row.groups[0].name }}</span>
          </template>
        </el-table-column>
      ...
      <el-form :model="adduserform">
        ...
        <el-form-item label="用户类型" :label-width="formLabelWidth">
          <el-radio-group v-model="adduserform.person_type" size="medium">
            <el-radio border label="3">admin</el-radio>
            <el-radio border label="2">passenger</el-radio>
            <el-radio border label="1">airport</el-radio>
            <el-radio border label="0">flight</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="用户管理状态" :label-width="formLabelWidth">
          <el-select v-model="adduserform.is_staff" placeholder="请选择用户状态">
