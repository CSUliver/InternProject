    ...
    <div id="datatable">
      <el-table border :data="tableData" style="width: 100%; margin-top: 15px">
        ...
        <el-table-column label="用户头像">
          <template slot-scope="scope">
            <el-image
              style="width: 40px; height: 40px" :src="scope.row.avatar"
            ></el-image>
          </template>
        </el-table-column>
        ...
        <el-table-column label="管理员权限">
          <template slot-scope="scope">
            <el-tooltip v-if="scope.row.person_type==='admin'"  
              :content="'机场管理员'" placement="top">
              <el-switch
...
export default {
  data() {
    return {
      ...
      // 编辑用户表单数据
      edituserform:{is_superuser:true},
  ...
  methods: {
    ...
    addUserInfo:function(){
      ...
      */
      ...
      addform.append('is_active',this.adduserform.is_superuser)     
    ...
    editUserInfo:function(){
      ...
      /*
        ...
        作用：一般用来异步上传二进制文件
      */
    //  if(this.edituserform.is_active = "1"){
    ...
    //   }
      ...
      editform.append('is_active',this.edituserform.is_superuser)
