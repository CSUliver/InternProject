  ...
  
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: '感染风险', icon: 'el-icon-warning', roles: ['passenger'] }
        },
        {
          path: 'map',
          name: '',
  ...
  
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: '感染风险', icon: 'el-icon-warning', roles: ['flight'] }
        },
        {
          path: 'map',
          name: '',
  ...
  
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: '感染风险', icon: 'el-icon-warning', roles: ['airport'] }
        },
        {
          path: 'map',
          name: '',
      ...
      children: [
        {
          ...
          meta: { title: '总体情况', icon: 'el-icon-s-data', roles: ['admin'] }
        },
        {
          path: 'infect',
          name: '',
          component: () => import('@/views/master/infect/index'),
          meta: { title: '感染风险', icon: 'el-icon-warning', roles: ['admin'] }
        },
        {
          path: 'map',
          name: '',
