 ...
 export const asyncRoutes = [
  {
  ...
  
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: '飞机搭载人员信息', icon: 'form', roles: ['admin','flight'] }
        },
        {
          path: 'infect',
          name: '',
  ...
  
    {
      ...
      name: 'service',
      meta: { title: '机场工作人员入口', icon: 'el-icon-user-solid', roles: ['admin','airport'] },
      children: [
        {
          path: 'task',
          name: '',
          component: () => import('@/views/service/task/index'),
          meta: { title: '出勤任务表', icon: 'form', roles: ['admin','airport'] }
        },
        {
          path: 'taskfinish',
          name: '',
