 ...
 
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: 'https://sugar.aipage.com/dashboard/d4731a374eae7c0322d8b534c450b44d',
  ...
  
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: 'https://sugar.aipage.com/dashboard/6cff7d56c0fbd2604749114e4766de76?conditions=%7B%22select1%22%3A7%2C%22select%22%3A316847%7D',
              meta: { title: '机场管理员大屏', icon: 'el-icon-s-platform', roles: ['admin'] }
            }
          ]
        },
      ]
