 ...
 export const asyncRoutes = [
  {
      ...
      name: 'Admin',
      meta: { title: '系统管理', icon: 'el-icon-s-help', roles: ['机场管理员','旅客'] },
      children: [
        {
          path: 'auth',
          name: 'Auth',
          component: () => import('@/views/admin/auth/index'),
          meta: { title: '权限管理', icon: 'table', roles: ['机场管理员','旅客'] }
        },
        {
          path: 'tree',
          name: 'Tree',
          component: () => import('@/views/admin/tree/index'),
          meta: { title: '日志管理', icon: 'tree', roles: ['机场管理员','旅客'] }
        }
      ]
    },
  
    {
      ...
      name: 'Passenger',
      meta: { title: '旅客入口', icon: 'el-icon-user', roles: ['旅客','机场管理员'] },
      children: [
        {
          path: 'flight',
          name: '',
          component: () => import('@/views/passenger/flight/index'),
          meta: { title: '航班情况', icon: 'el-icon-s-promotion', roles: ['旅客','机场管理员'] }
        },
        {
          path: 'infect',
          name: '',
          component: () => import('@/views/passenger/infect/index'),
          meta: { title: '感染风险', icon: 'el-icon-warning', roles: ['旅客','机场管理员'] }
        },
        {
          path: 'map',
          name: '',
