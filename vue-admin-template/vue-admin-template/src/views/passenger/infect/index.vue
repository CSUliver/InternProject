      ...
      <div id="datatable">
        ...
        >
          ...
          <el-table-column label="警示时间">
            <template slot-scope="scope">
               <el-tag v-if="scope.row.alarm_level==='2'" effect="light" type="warning">{{ scope.row.time }}</el-tag>
               <el-tag v-else-if="scope.row.alarm_level==='3'" effect="light" type="danger">{{ scope.row.time }}</el-tag>
            </template>
          </el-table-column>
          <el-table-column label="感染风险预警编号">
            <template slot-scope="scope">
              <!-- <el-tag type="" effect="light">{{scope.row.risk_id}}</el-tag> -->
              <el-tag v-if="scope.row.alarm_level==='2'" effect="light" type="warning">{{ scope.row.risk_id }}</el-tag>
              <el-tag v-else-if="scope.row.alarm_level==='3'" effect="light" type="danger">{{ scope.row.risk_id }}</el-tag>
          ...
          <el-table-column label="机场管理人员编号">
            <template slot-scope="scope">
              ...
              <el-tag v-if="scope.row.alarm_level==='2'" effect="light" type="warning">{{ scope.row.staff_id }}</el-tag>
              <el-tag v-else-if="scope.row.alarm_level==='3'" effect="light" type="danger">{{ scope.row.staff_id }}</el-tag>
            </template>
          </el-table-column>
        </el-table>
      </div>
