<template>
  <div id="body">
    ...
    <!-- 新增用户模态框 -->
    <el-dialog title="新增任务" :visible.sync="addFormVisible">
      <!-- {{addform}}  -->
  ...
  methods: {
    ...
    fetchTaskData: function () {
      request({
        ...
        params: 
        //this.params,
        {"page":this.params.page,"page_size":this.params.page_size,
    ...
    handleDelete(userid) {
      console.log(userid);
      this.$confirm("此操作将永久删除该条任务数据, 是否继续?", "提示", {
